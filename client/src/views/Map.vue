<template>
  <div>
      ...
      xmlns="http://www.w3.org/2000/svg">
            ...
            id="AL" name="Albania"
            :class="isClickable('Albania') ? 'system-country' : 'not-in-system'"
            ...
            id="AD" name="Andorra"
            :class="isClickable('Andorra') ? 'system-country' : 'not-in-system'"
            ...
            id="AT" name="Austria"
            :class="isClickable('Austria') ? 'system-country' : 'not-in-system'"
            ...
            id="BE" name="Belgium"
            :class="isClickable('Belgium') ? 'system-country' : 'not-in-system'"
            ...
            id="BG" name="Bulgaria"
            :class="isClickable('Bulgaria') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('Bosnia and Herzegovina') ? 'system-country' : 'not-in-system'"
            ...
            id="BY" name="Belarus"
            :class="isClickable('Belarus') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('Switzerland') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('Czech Republic') ? 'system-country' : 'not-in-system'"
            ...
            id="DE" name="Germany"
            :class="isClickable('Germany') ? 'system-country' : 'not-in-system'"
            ...
            id="DK" name="Denmark"
            :class="isClickable('Denmark') ? 'system-country' : 'not-in-system'"
            ...
            id="EE" name="Estonia"
            :class="isClickable('Estonia') ? 'system-country' : 'not-in-system'"
            ...
            id="FI" name="Finland"
            :class="isClickable('Finland') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('United Kingdom') ? 'system-country' : 'not-in-system'"
            ...
            id="GR" name="Greece"
            :class="isClickable('Greece') ? 'system-country' : 'not-in-system'"
            ...
            id="HR" name="Croatia"
            :class="isClickable('Croatia') ? 'system-country' : 'not-in-system'"
            ...
            id="HU" name="Hungary"
            :class="isClickable('Hungary') ? 'system-country' : 'not-in-system'"
            ...
            id="IE" name="Ireland"
            :class="isClickable('Ireland') ? 'system-country' : 'not-in-system'"
            ...
            id="IS" name="Iceland"
            :class="isClickable('Iceland') ? 'system-country' : 'not-in-system'"
            ...
            id="IT" name="Italy"
            :class="isClickable('Italy') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('Liechtenstein') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('Lithuania') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('Luxembourg') ? 'system-country' : 'not-in-system'"
            ...
            id="LV" name="Latvia"
            :class="isClickable('Latvia') ? 'system-country' : 'not-in-system'"
            ...
            id="MD" name="Moldova"
            :class="isClickable('Moldova') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('Macedonia') ? 'system-country' : 'not-in-system'"
            ...
            :class="isClickable('Montenegro') ? 'system-country' : 'not-in-system'"
            ...
            id="NO" name="Norway"
            :class="isClickable('Norway') ? 'system-country' : 'not-in-system'"
            ...
            id="PL" name="Poland"
            :class="isClickable('Poland') ? 'system-country' : 'not-in-system'"
            ...
            id="RO" name="Romania"
            :class="isClickable('Romania') ? 'system-country' : 'not-in-system'"
            ...
            id="RS" name="Serbia"
            :class="isClickable('Serbia') ? 'system-country' : 'not-in-system'"
            ...
            id="SK" name="Slovakia"
            :class="isClickable('Slovakia') ? 'system-country' : 'not-in-system'"
            ...
            id="SI" name="Slovenia"
            :class="isClickable('Slovenia') ? 'system-country' : 'not-in-system'"
            ...
            id="SE" name="Sweden"
            :class="isClickable('Sweden') ? 'system-country' : 'not-in-system'"
            ...
            id="TR" name="Türkiye"
            :class="isClickable('Türkiye') ? 'system-country' : 'not-in-system'"
            ...
            id="UA" name="Ukraine"
            :class="isClickable('Ukraine') ? 'system-country' : 'not-in-system'"
            ...
            id="XK"
            name="Kosovo"
            :class="isClickable('Kosovo') ? 'system-country' : 'not-in-system'"
            ...
            id="NL"
            name="Netherlands"
            :class="isClickable('Netherlands') ? 'system-country' : 'not-in-system'"
            ...
            id="ES"
            name="Spain"
            :class="isClickable('Spain') ? 'system-country' : 'not-in-system'"
            ...
            id="FR"
            name="France"
            :class="isClickable('France') ? 'system-country' : 'not-in-system'"
            ...
            id="PT"
            name="Portugal"
            :class="isClickable('Portugal') ? 'system-country' : 'not-in-system'"
...
export default {
  ...
  methods: {
    ...
    isClickable(country) {
      return this.isAdmin || this.isInSystem(country) // Admins can click all countries, users only clickable if in the system
    },
    async checkIfAdmin() {
      try {
    ...
    countryClicked(country) {
      ...
      // Check if no cities are available for the selected country
      if (!this.isAdmin && this.filteredCities.length === 0) {
        return
      }

      if (this.filteredCities.length === 0 && this.isAdmin) {
        this.filteredCities = [{ cityName: 'No cities for this country yet', _id: 'no-cities' }] // Set a placeholder _id
      }

      // Show the city popup regardless (since it's allowed for admins)
